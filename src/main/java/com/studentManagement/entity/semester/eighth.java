...
public class eighth {
    ...
    @ManyToOne
    @JoinColumn(name = "student_id7", nullable = false)
    private Student student7;

    public eighth(Long id, String id1, String subjectName, String internals, String externals, String regulation, String attendance, Student student1) {
        this.id = id;
        this.id1 = id1;
    ...
    public void setStudent7(Student std)
    {
        student7=std;
    }
