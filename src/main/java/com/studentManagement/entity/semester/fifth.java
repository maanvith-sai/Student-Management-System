...
public class fifth {
    ...
    @ManyToOne
    @JoinColumn(name = "student_id4", nullable = false)
    private Student student4;

    public fifth(Long id, String id1, String subjectName, String internals, String externals, String regulation, String attendance, Student student1) {
        this.id = id;
        this.id1 = id1;
    ...
    public void setStudent4(Student std)
    {
        student4=std;
    }
