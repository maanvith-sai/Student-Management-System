...
public class fourth {
    ...
    @ManyToOne
    @JoinColumn(name = "student_id3", nullable = false)
    private Student student3;

    public fourth(Long id, String id1, String subjectName, String internals, String externals, String regulation, String attendance, Student student3) {
        this.id = id;
        this.id1 = id1;
    ...
    public void setStudent3(Student std)
    {
        student3=std;
    }
